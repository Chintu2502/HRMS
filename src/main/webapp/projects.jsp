						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<h4 class="project-title"><a href="project-view.jsp">Project Management</a></h4>
									<small class="block text-ellipsis m-b-15">
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<h4 class="project-title"><a href="project-view.jsp">Video Calling App</a></h4>
									<small class="block text-ellipsis m-b-15">
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<h4 class="project-title"><a href="project-view.jsp">Hospital Administration</a></h4>
									<small class="block text-ellipsis m-b-15">
...
<jsp:include page="includes/projects/add.jsp" />
<!-- /Create Project Modal -->

<!-- Edit Project Modal -->
<jsp:include page="includes/projects/edit.jsp" />
<!-- /Edit Project Modal -->

<!-- Delete Project Modal -->
<jsp:include page="includes/projects/delete.jsp" />
<!-- /Delete Project Modal -->
